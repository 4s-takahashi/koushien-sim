export const MATCH_CONSTANTS = {
  ...
  STRIKE_ZONE_TARGET_BASE: 0.75,
  CONTROL_ERROR_SCALE: 2.0,

  // === 打撃 ===
  BASE_CONTACT_RATE: 0.85,
  BREAK_CONTACT_PENALTY: 0.04,
  VELOCITY_CONTACT_PENALTY: 0.0015,
  FAIR_BASE_RATE: 0.55,
  TECHNIQUE_FAIR_BONUS: 0.25,

  // === 打球 ===
  HOME_RUN_DISTANCE: 100,
  FLY_MAX_DISTANCE: 130,

  // === 守備 ===
  FLY_CATCH_BASE: 0.80,
  GROUND_OUT_BASE: 0.55,
  DOUBLE_PLAY_BASE: 0.30,
  ERROR_POPUP_RATE: 0.05,
